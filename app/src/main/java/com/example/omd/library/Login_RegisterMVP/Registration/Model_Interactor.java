...
public interface Model_Interactor {
    ...
    //
    void NormalUserRegistration(String userType,String photoName,String photo,String first_name, String last_name, String email, String country, String phone, String username, String password ,Model_Interactor.onCompleteListener listener, Context context);
    ...
    void CompanyRegistration(String userType,String name,String email,String country,String phone,String username,String password,String address,String town,String site,Model_Interactor.onCompleteListener listener, Context context);
