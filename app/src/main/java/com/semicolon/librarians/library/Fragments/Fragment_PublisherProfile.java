...
public class Fragment_PublisherProfile extends Fragment implements View.OnClickListener , com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.ViewData,ViewData{
    ...
    private com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.Presenter pubPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pubPresenter = new com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.PresenterImp(this,getActivity());
