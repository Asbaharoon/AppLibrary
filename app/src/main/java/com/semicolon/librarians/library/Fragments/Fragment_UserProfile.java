...
public class Fragment_UserProfile extends Fragment implements View.OnClickListener , com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.ViewData,ViewData{
    ...
    private com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.Presenter userPresenter;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        userPresenter = new com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.PresenterImp(this,getActivity());
