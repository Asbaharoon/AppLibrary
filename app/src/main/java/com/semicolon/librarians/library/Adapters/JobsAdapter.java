...
public class JobsAdapter extends RecyclerView.Adapter<JobsAdapter.ViewHolder>  {
    ...
    class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        TextView Content_jobTitle,Content_jobContent,Content_jobStartDate,Content_jobEndDate,Content_jobRequirements,Content_jobCompanyName,Content_jobPhone,Content_jobEmail;
        ...
        private void initContentView(View contentView) {
            ...
            Content_jobContent  = (TextView) contentView.findViewById(R.id.job_content_content);
        ...
        public void BindData(JobsModel jobsModel)
        {
           ...
           /* Long sd = Long.getLong(jobsModel.getJobStartDate());
            ...
            Content_jobStartDate.setText("");
            Content_jobEndDate.setText("");
