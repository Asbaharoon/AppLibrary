...
public class Fragment_CompanyProfile extends Fragment implements View.OnClickListener, com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.ViewData,ViewData{
    ...
    private com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.Presenter compPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        compPresenter = new com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.PresenterImp(this,getActivity());
