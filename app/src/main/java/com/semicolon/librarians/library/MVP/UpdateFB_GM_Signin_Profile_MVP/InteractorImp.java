...
public class InteractorImp implements Interactor {
   ...
   private Retrofit setUpRetrofit()
   {
    ...
    @Override
    public void UpdateUserData(String user_photo, String user_userName, String user_name, String user_email, String user_phone, String user_country, onCompleteListener listener) {
        ...
        else if (TextUtils.isEmpty(user_country))
        {
            ...
            {
                UpdataData(user_photo,user_userName,user_name,user_email,user_phone,user_country,listener);
            }
    }

    private void UpdataData(String user_photo, String user_userName, String user_name, String user_email, String user_phone, String user_country, final onCompleteListener listener) {
        ...
        call.enqueue(new Callback<NormalUserData>() {
            ...
            public void onResponse(Call<NormalUserData> call, Response<NormalUserData> response) {
                if (response.isSuccessful())
                {
                    ...
                    {
                        listener.onFailed("Error Something haywire");
                    }
            }
