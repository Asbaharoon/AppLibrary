...
public class Fragment_UniversityProfile extends Fragment implements View.OnClickListener, com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.ViewData,ViewData{
    ...
    private com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.Presenter uniPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        uniPresenter = new com.semicolon.librarians.library.MVP.DisplayUsersDataMVP.PresenterImp(this,getActivity());
