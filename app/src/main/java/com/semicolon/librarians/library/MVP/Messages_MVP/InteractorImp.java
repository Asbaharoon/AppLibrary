...
public class InteractorImp implements Interactor {
   ...
   private Retrofit setUpRetrofit()
   {
    ...
    @Override
    public void getMessages(String currUser_userName, String chatUser_userName, final onCompleteListener listener) {
    ...
    @Override
    public void sendMessage(String senderid, String receiverid, String sender_name, String receiver_name, String message, String sender_photo, final onCompleteListener listener) {
