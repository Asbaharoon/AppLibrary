...
public class Fragment_LibraryProfile extends Fragment implements View.OnClickListener, com.semicolon.librarians.libraryguide.MVP.DisplayUsersDataMVP.ViewData,ViewData{
    ...
    private com.semicolon.librarians.libraryguide.MVP.DisplayUsersDataMVP.Presenter libPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        libPresenter = new com.semicolon.librarians.libraryguide.MVP.DisplayUsersDataMVP.PresenterImp(this,getActivity());
