...
public class PresenterImp implements Presenter,Model_Interactor.onCompleteListener {
    ...
    public void setNormalUserPhoto_Error() {
        if (viewData!=null)
        {
            viewData.setNormalUserPhoto_Error();
        }
    }
    ...
    public void setPublisherPhoto_Error() {
        if (viewData!=null)
        {
            viewData.setPublisherPhoto_Error();
        }
    }
    ...
    public void setLibraryPhoto_Error() {
        if (viewData!=null)
        {
            viewData.setLibraryPhoto_Error();
        }
    }
    ...
    public void setUniversityPhoto_Error() {
        if (viewData!=null)
        {
            viewData.setUniversityPhoto_Error();
        }
    }
    ...
    public void setCompanyPhoto_Error() {
        if (viewData!=null)
        {
            viewData.setCompanyPhoto_Error();
        }
    }
